/* eslint-disable */
// Auto-generated WASM glue code - do not edit manually
let wasm;
 ...
 * @returns {string}
 */
export function computeBlindedProxy(commitment_hex, position) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(commitment_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.computeBlindedProxy(ptr0, len0, position);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {string}
 */
export function computeCommitment(owner_pk_hex, value, blinding_hex) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const ret = wasm.computeCommitment(ptr0, len0, value, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @param {string} spending_key_hex
 * @param {string} commitment_hex
 * @param {bigint} position
 * @returns {string}
 */
export function computeNullifier(spending_key_hex, commitment_hex, position) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(spending_key_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(commitment_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.computeNullifier(ptr0, len0, ptr1, len1, position);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {string}
 */
export function derivePublicKey(spending_key_hex) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(spending_key_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {any}
 */
export function generateWitness(spending_key_hex, value, blinding_hex, position) {
    const ptr0 = passStringToWasm0(spending_key_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(blinding_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.generateWitness(ptr0, len0, value, ptr1, len1, position);
    if (ret[2]) {
 ...
 * @param {string} blinding_hex
 * @param {bigint} position
 * @param {string} expected_commitment_hex
 * @param {string} expected_nullifier_hex
 * @param {string} expected_proxy_hex
 * @returns {boolean}
 */
export function verifyWitness(spending_key_hex, value, blinding_hex, position, expected_commitment_hex, expected_nullifier_hex, expected_proxy_hex) {
    const ptr0 = passStringToWasm0(spending_key_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(blinding_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(expected_commitment_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ptr3 = passStringToWasm0(expected_nullifier_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len3 = WASM_VECTOR_LEN;
    const ptr4 = passStringToWasm0(expected_proxy_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len4 = WASM_VECTOR_LEN;
    const ret = wasm.verifyWitness(ptr0, len0, value, ptr1, len1, position, ptr2, len2, ptr3, len3, ptr4, len4);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0] !== 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('zelana_ownership_prover_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
